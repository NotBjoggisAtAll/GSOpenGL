...
void Shader::setInt(const char *name, const int data)
{
    glUniform1i(getUniformLocation(name), data);
}

void Shader::setFloat(const char *name, const float data)
{
    glUniform1f(getUniformLocation(name), data);
}

void Shader::setVec3(const char* name, const float* data)
{
